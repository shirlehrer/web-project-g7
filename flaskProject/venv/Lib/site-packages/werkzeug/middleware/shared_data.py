...
class SharedDataMiddleware:
    ...
    """A WSGI middleware which provides css content for development
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/css': ('myapplication', 'css')
        })

    This will then serve the ``css`` folder in the `myapplication`
    Python package.
